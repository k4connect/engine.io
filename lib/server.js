...
function Server (opts) {
  ...
  if (~this.transports.indexOf('websocket')) {
    // keep require('@k4connect/ws') as separate expression for packers (browserify, etc)
    var WebSocketServer = (this.wsEngine ? require(this.wsEngine) : require('@k4connect/ws')).Server;
